 ...
 *                   folder, then the SALES_ROOT environment variable. Used to
 *                   find strategy/voice.md and strategy/proof-inventory.md.
...
function selftest() {
  ...
  const cases = [
    ...
    ["a path in backticks is fine", "The ledger is `crm/signals.jsonl` and it appends.", "strategy", ctx, []],
    ["a bare kit path is fine", "Write it to crm/signals.jsonl every run.", "plain", ctx, []],
    ["a filename is not a link", "Open queue/2026-03-04-email.md and tick the boxes.", "plain", ctx, []],
