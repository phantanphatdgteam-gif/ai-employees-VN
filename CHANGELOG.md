...
## Proof inventory fix in six kits and their Vietnam variants, 2026-09-24

`copy-check.mjs` failed every copy check in an install whose proof inventory still held the contract's own `Format: <the exact string that may appear in copy> | <ledger path it was read from> | <YYYY-MM-DD>` line, which the first run of each of these kits writes. The line is now skipped as documentation, a real entry without a ledger path or a date is still rejected, and a new selftest check covers both. Versions: Ad Manager Employee 1.8.1, Chief of Staff 1.8.2, Customer Satisfaction Employee 1.8.1, GTM Engineer 1.8.1, Sales Employee 1.8.1, Social Media Employee 1.8.2; Vietnam variants `ad-manager-employee-vn` 1.9.1, `chief-of-staff-vn` 1.9.1, `customer-satisfaction-employee-vn` 1.9.1, `gtm-engineer-vn` 1.11.1, `sales-employee-vn` 1.9.1, `social-media-employee-vn` 1.9.1. See the changelogs of [Ad Manager Employee](employees/ad-manager-employee/CHANGELOG.md), [Chief of Staff](employees/chief-of-staff/CHANGELOG.md), [Customer Satisfaction Employee](employees/customer-satisfaction-employee/CHANGELOG.md), [GTM Engineer](employees/gtm-engineer/CHANGELOG.md), [Sales Employee](employees/sales-employee/CHANGELOG.md), [Social Media Employee](employees/social-media-employee/CHANGELOG.md), and of the variants [ad-manager-employee-vn](employees/ad-manager-employee-vn/CHANGELOG.md), [chief-of-staff-vn](employees/chief-of-staff-vn/CHANGELOG.md), [customer-satisfaction-employee-vn](employees/customer-satisfaction-employee-vn/CHANGELOG.md), [gtm-engineer-vn](employees/gtm-engineer-vn/CHANGELOG.md), [sales-employee-vn](employees/sales-employee-vn/CHANGELOG.md), [social-media-employee-vn](employees/social-media-employee-vn/CHANGELOG.md). The public npm package still ships the previous kits until the maintainer bumps the root version and publishes.
